...
Vagrant.configure(2) do |config|
  ...
  #config.vm.provision "shell", inline: "echo 'sudo docker run -v /vagrant:/ansible --rm -p 2222:22 -it theknightcoder/ansible-networking bash' >> /home/vagrant/start-ansible.sh"
